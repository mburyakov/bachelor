...
\ \ reeds: typeOf(this.leftHandSide), typeOf(this.rightHandSide)\\
\ \ outputs: typeOf(this)\\
\ \ type: \{
\ \ \ \ typeVar leftType = typeOf(this.leftHandSide);
\ \ \ \ typeVar rightType = typeOf(this.rightHandSide);
\ \ \ \ case tryAssignmentConversion(rightType, leftType) of \{
\ \ \ \ \ \ "allowed" -> return;
